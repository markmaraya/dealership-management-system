...
export class ApiService {
  ...
  getUnits(): Observable<Units[]> {
    ...
    return this.http.get<Units[]>(`${apiUrl}`)
      .pipe(
  ...
  getUnitsById(id: string): Observable<Units> {
    const url = `${apiUrl}/${id}`;
  ...
  getUnitsByUnitCode(unitCode: string): Observable<Units> {
    ...
    return this.http.get<Units>(url).pipe(
      ...
      catchError(this.handleError<Units>(`getUnitsByUnitCode unitCode=${unitCode}`))
    );
  }
  ...
  getExpensesByUnitCode(unitCode: string): Observable<Expenses> {
    ...
    return this.http.get<Expenses>(url).pipe(
      ...
      catchError(this.handleError<Expenses>(`getExpensesByUnitCode unitCode=${unitCode}`))
    );
  }
  ...
  getGalleryById(id: string): Observable<any> {
    ...
    return this.http.get<Gallery>(url).pipe(
      catchError(this.handleGalleryError)
    );
  }
